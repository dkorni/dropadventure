...
{
    /// <summary>
    /// IMPORTANT NOTE: This class is a duplicated class of AndroidManifestUtils.
    /// but we need to wait until Core 1.6 in order to point to the correct class with the new method UpdatePermissionInManifest. 
    /// </summary>
    public static class TempAndroidManifestUtilsUntilNextCoreRelease
    {
