...
{
    internal class ZibraLiquidsBakingUtility : EditorWindow
    {
        ...
        [MenuItem("Zibra AI/Zibra Liquids/Initial State Baking Utility", false, 700)]
        public static void ShowWindow()
        {
            GetWindow<ZibraLiquidsBakingUtility>("Zibra Liquids Baking Utility");
        }
...
#else
            int header = ZibraLiquid.BAKED_LIQUID_PAID_HEADER_VALUE;
#endif
