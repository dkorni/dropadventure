...
{
    [AddComponentMenu("")]
    public class Performance_RamManager : MonoBehaviour, IMovable, IModifiableState
    {
        /* ----- TODO: ----------------------------
        ...
        private                 Performance_RamGraph                  m_ramGraph = null;
        private                 Performance_RamText                   m_ramText = null;
        ...
        private void Init()
        {
            ...
            m_ramGraph      = GetComponent<Performance_RamGraph>();
            m_ramText       = GetComponent<Performance_RamText>();
