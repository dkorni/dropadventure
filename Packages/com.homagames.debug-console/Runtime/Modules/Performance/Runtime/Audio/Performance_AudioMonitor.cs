...
namespace HomaGames.HomaConsole.Performance.Audio
{
    ...
    /// </summary>
    [AddComponentMenu("")]
    public class Performance_AudioMonitor : MonoBehaviour
    {
        ...
        private         PerformanceManager.LookForAudioListener  m_findAudioListenerInCameraIfNull   = PerformanceManager.LookForAudioListener.ON_SCENE_LOAD;
            ...
            if (m_audioListener != null)
            {
                ...
                for (int i = 0; i < Spectrum.Length; i++)
                {
                    ...
                    else
                    {
                     ...
                     &&  m_findAudioListenerInCameraIfNull == PerformanceManager.LookForAudioListener.ALWAYS)
            {
        ...
        public void UpdateParameters()
        {
            ...
            if (m_audioListener == null
                    && m_findAudioListenerInCameraIfNull != PerformanceManager.LookForAudioListener.NEVER)
            {
                m_audioListener = FindAudioListener();
            }
        ...
        {
            if (m_findAudioListenerInCameraIfNull == PerformanceManager.LookForAudioListener.ON_SCENE_LOAD)
            {
                m_audioListener = FindAudioListener();
            }
        }
