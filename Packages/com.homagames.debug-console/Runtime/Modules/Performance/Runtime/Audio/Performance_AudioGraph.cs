...
{
    [AddComponentMenu("")]
    public class Performance_AudioGraph : Performance_Graph
    {
        ...
        private                     Performance_GraphShader   m_shaderGraph = null;
        private                     Performance_GraphShader   m_shaderGraphHighestValues = null;
        ...
        public void UpdateParameters()
        {
            ...
            switch (m_graphyManager.GraphyMode)
            {
                case PerformanceManager.Mode.FULL:
                    m_shaderGraph.ArrayMaxSize                  = Performance_GraphShader.ArrayMaxSizeFull;
                    m_shaderGraph.Image.material                = new Material(ShaderFull);

                    m_shaderGraphHighestValues.ArrayMaxSize     = Performance_GraphShader.ArrayMaxSizeFull;
                    m_shaderGraphHighestValues.Image.material   = new Material(ShaderFull);
                    break;

                case PerformanceManager.Mode.LIGHT:
                    m_shaderGraph.ArrayMaxSize                  = Performance_GraphShader.ArrayMaxSizeLight;
                    m_shaderGraph.Image.material                = new Material(ShaderLight);

                    m_shaderGraphHighestValues.ArrayMaxSize     = Performance_GraphShader.ArrayMaxSizeLight;
        ...
        private void Init()
        {
            ...
            m_shaderGraph = new Performance_GraphShader
            {
                Image = m_imageGraph
            };

            m_shaderGraphHighestValues = new Performance_GraphShader
            {
