...
using System;
using HomaGames.HomaConsole.Performance.Audio;
using HomaGames.HomaConsole.Performance.Fps;
using HomaGames.HomaConsole.Performance.Ram;
...
namespace HomaGames.HomaConsole.Performance
{
    /// <summary>
    /// Main class to access the Graphy API.
    /// </summary>
    [AddComponentMenu("")]
    public class PerformanceManager : Performance_Singleton<PerformanceManager>
    {
        ...
        private                     Performance_FpsManager            m_fpsManager                        = null;
        private                     Performance_RamManager            m_ramManager                        = null;
        private                     Performance_AudioManager          m_audioManager                      = null;
        ...
        {
            Performance_IntString.Dispose();
            Performance_FloatString.Dispose();
        }
        ...
        private void Init()
        {
            ...
            m_fpsMonitor    = GetComponentInChildren(typeof(Performance_FpsMonitor),    true) as Performance_FpsMonitor;
            m_ramMonitor    = GetComponentInChildren(typeof(Performance_RamMonitor),    true) as Performance_RamMonitor;
            m_audioMonitor  = GetComponentInChildren(typeof(Performance_AudioMonitor),  true) as Performance_AudioMonitor;
            
            m_fpsManager    = GetComponentInChildren(typeof(Performance_FpsManager),    true) as Performance_FpsManager;
            m_ramManager    = GetComponentInChildren(typeof(Performance_RamManager),    true) as Performance_RamManager;
            m_audioManager  = GetComponentInChildren(typeof(Performance_AudioManager),  true) as Performance_AudioManager;
