...
namespace HomaGames.HomaConsole.Logs
{
	public class DebugLogLogcatListener : AndroidJavaProxy
	{
		...
		public DebugLogLogcatListener() : base( "com.homagames.homaconsole.DebugConsoleLogcatLogReceiver" )
		{
		...
		{
			if( nativeObject == null )
				nativeObject = new AndroidJavaObject( "com.homagames.homaconsole.DebugConsoleLogcatLogger" );
