...
namespace HomaGames.HomaConsole.Logs
{
	...
	public class DebugLogItem : MonoBehaviour, IPointerClickHandler
	{
		...
		private static AndroidJavaClass AJC
		{
			...
			{
				if( m_ajc == null )
					m_ajc = new AndroidJavaClass( "com.homagames.homaconsole.DebugConsole" );
		...
		private static extern void _Homa_DebugConsole_CopyText( string text );
#endif
#endif
		#endregion
...
#elif UNITY_IOS
			_Homa_DebugConsole_CopyText( log );
#endif
		}
