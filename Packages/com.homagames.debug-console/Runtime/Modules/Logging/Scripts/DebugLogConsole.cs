...
namespace HomaGames.HomaConsole.Logs
{
	...
	public static class DebugLogConsole
	{
		...
		public static void LogSystemInfo()
		{
			...
			stringBuilder.Append( "Rig: " ).AppendSysInfoIfPresent( UnityEngine.SystemInfo.deviceModel ).AppendSysInfoIfPresent( UnityEngine.SystemInfo.processorType )
				.AppendSysInfoIfPresent( UnityEngine.SystemInfo.systemMemorySize, "MB RAM" ).Append( UnityEngine.SystemInfo.processorCount ).Append( " cores\n" );
			stringBuilder.Append( "OS: " ).Append( UnityEngine.SystemInfo.operatingSystem ).Append( "\n" );
			stringBuilder.Append( "GPU: " ).Append( UnityEngine.SystemInfo.graphicsDeviceName ).Append( " " ).Append( UnityEngine.SystemInfo.graphicsMemorySize )
				.Append( "MB " ).Append( UnityEngine.SystemInfo.graphicsDeviceVersion )
				.Append( UnityEngine.SystemInfo.graphicsMultiThreaded ? " multi-threaded\n" : "\n" );
			...
			stringBuilder.Append( "Device ID: " ).Append( UnityEngine.SystemInfo.deviceUniqueIdentifier ).Append( "\n" );
			stringBuilder.Append( "Max Texture Size: " ).Append( UnityEngine.SystemInfo.maxTextureSize ).Append( "\n" );
#if UNITY_5_6_OR_NEWER
			stringBuilder.Append( "Max Cubemap Size: " ).Append( UnityEngine.SystemInfo.maxCubemapSize ).Append( "\n" );
#endif
			stringBuilder.Append( "Accelerometer: " ).Append( UnityEngine.SystemInfo.supportsAccelerometer ? "supported\n" : "not supported\n" );
			stringBuilder.Append( "Gyro: " ).Append( UnityEngine.SystemInfo.supportsGyroscope ? "supported\n" : "not supported\n" );
			stringBuilder.Append( "Location Service: " ).Append( UnityEngine.SystemInfo.supportsLocationService ? "supported\n" : "not supported\n" );
...
#endif
			stringBuilder.Append( "Compute Shaders: " ).Append( UnityEngine.SystemInfo.supportsComputeShaders ? "supported\n" : "not supported\n" );
			stringBuilder.Append( "Shadows: " ).Append( UnityEngine.SystemInfo.supportsShadows ? "supported\n" : "not supported\n" );
			stringBuilder.Append( "Instancing: " ).Append( UnityEngine.SystemInfo.supportsInstancing ? "supported\n" : "not supported\n" );
			stringBuilder.Append( "Motion Vectors: " ).Append( UnityEngine.SystemInfo.supportsMotionVectors ? "supported\n" : "not supported\n" );
			stringBuilder.Append( "3D Textures: " ).Append( UnityEngine.SystemInfo.supports3DTextures ? "supported\n" : "not supported\n" );
#if UNITY_5_6_OR_NEWER
			stringBuilder.Append( "3D Render Textures: " ).Append( UnityEngine.SystemInfo.supports3DRenderTextures ? "supported\n" : "not supported\n" );
#endif
			stringBuilder.Append( "2D Array Textures: " ).Append( UnityEngine.SystemInfo.supports2DArrayTextures ? "supported\n" : "not supported\n" );
			stringBuilder.Append( "Cubemap Array Textures: " ).Append( UnityEngine.SystemInfo.supportsCubemapArrayTextures ? "supported" : "not supported" );
		...
		{
			if( info != UnityEngine.SystemInfo.unsupportedIdentifier )
			{
				sb.Append( info );
		...
		public static bool ParseArray( string input, Type arrayType, out object output )
		{
			...
			IList result = (IList) System.Activator.CreateInstance( arrayType, new object[1] { valuesToParse.Count } );
			output = result;
